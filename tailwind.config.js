...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'brand-sm': '0 2px 8px rgba(65, 32, 17, 0.08)',
        'brand-md': '0 8px 24px rgba(65, 32, 17, 0.14)',
        'brand-lg': '0 20px 48px rgba(65, 32, 17, 0.18)',
      ...
      keyframes: {
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 0 0   rgba(65, 32, 17, 0.45)' },
          '50%':      { boxShadow: '0 0 0 12px rgba(65, 32, 17, 0)'   },
        },
        shimmer: {
